        ...
        <div>
            <div className="main-center">
                <div className="navigator">
                  <a href="/" style={{color: "black"}}>homepage</a> \ <a href="/publications" style={{color: "black"}}>publications</a> \ EpiGNN
                </div>
                ...
                {/* <Button type="primary" size="small" onClick={()=>{window.open("/","_self")}}><CaretLeftOutlined /><span style={{marginLeft:'2px'}}>Back</span></Button> */}
                  <Button type="primary" size="small" onClick={()=>{window.open("https://link.springer.com/chapter/10.1007/978-3-031-26422-1_29")}}>Paper</Button>
