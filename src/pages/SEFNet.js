            ...
            <div className="main">
                ...
                <div className="rightcontainer">
                    ...
                    <div style={{marginTop: '8px'}}>
                      ...
                      <Button type="primary" size="small" style={{marginLeft: '8px'}} onClick={()=>{window.open("https://www.researchgate.net/publication/361098103_Inter-_and_Intra-Series_Embeddings_Fusion_Network_for_Epidemiological_Forecasting")}}>PDF</Button>
