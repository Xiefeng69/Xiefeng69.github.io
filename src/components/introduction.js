...
const Introduction = () => {
    return (
        <div className={style.introcontainer}>
            <span style={{fontSize: '1.6rem', fontWeight: '600'}}>Hello, I am Feng Xie (谢锋) ~ </span>
            <span style={{marginTop: '10px'}}>Currently, I am a Master Candidate in <span style={{fontWeight:'bold', color:'#000'}}><a style={{color: "black"}} href="https://www.nudt.edu.cn/" target="_blank">National University of Defense Technology</a></span>, under the supervision of Prof. Bin Zhou. I received my B.Eng. Degree from <span style={{fontWeight:'bold'}}><a style={{color: "#000"}} href="https://www.dlut.edu.cn/" target="_blank">Dalian University of Technology</a></span> in June 2021.</span>
            <span style={{marginTop: '10px'}}>My study interests include:</span>
            <ul style={{lineHeight:1.6, marginBottom:0}}>
                <li style={{marginBottom:0}}><span style={{fontWeight:'bold'}}>Applied Machine Learning</span> in real world problems, such as time series analysis, graph data modeling.</li>
                <li style={{marginBottom:0}}><span style={{fontWeight:'bold'}}>Text Mining and Knowledge Discovery</span> such as sentiment classification, knowledge graph alignment.</li>
            </ul>
