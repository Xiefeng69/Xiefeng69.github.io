...
const Introduction = () => {
    return (
        <div className={style.introcontainer}>
            ...
            <span style={{marginTop: '10px'}}>Currently, I am a Master Candidate in <span style={{fontWeight:'bold', color:'#333333'}}><a style={{color: "black"}} href="https://www.nudt.edu.cn/" target="_blank">National University of Defense Technology</a></span> (NUDT, Changsha, Hunan), advised by Bin Zhou. I received my B.Eng. Degree from <span style={{fontWeight:'bold'}}><a style={{color: "#333333"}} href="https://www.dlut.edu.cn/" target="_blank">Dalian University of Technology</a></span> in 2021.</span>
